...
void Bon_draw_cube(int map[16][255][16],int _px,int _py,int _pz,int ax, int ay, int az,float s){
       ...
       float ltbu = 1;//0.5 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       float ltbb = 1;//0.5 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       
       float ltuu = 1;//0.7 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       float ltub = 1;//0.7 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       
       float ltxpu = 1;//0.4 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       float ltxpb = 1;//0.4 +((py/100)*0.5);//+ ((_py-2)/100) * 5;
       
       float ltzpu = 1;//0.5 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       float ltzpb = 1;//0.5 +((py/100)*0.5);//+ ((_py-2)/100) * 5;
       
       float ltxnu = 1;//0.6 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       float ltxnb = 1;//0.6 +((py/100)*0.5);//+ ((_py-2)/100) * 5;
       
       float ltznu = 1;//0.7 +((py/100)*0.5);//+ ((_py+2)/100) * 5;
       float ltznb = 1;//0.7 +((py/100)*0.5);//+ ((_py-2)/100) * 5;
