...
// --- WALL BUILDING ---
int wleft_wall_gen_mode = 0;
int right_wall_gen_mode = 0;
int front_wall_gen_mode = 0;
int wback_wall_gen_mode = 0;

// --- WALL LIMIT DEFINE ---
int min_wall_size = 1;
int max_wall_size = 178;

// --- ROOM DEFINE ---
int roof_define_gen_mode = 0;
int roof_frequency_of_gen=10;

// --- NATURE DEFINITION ---
int floor_base_size = 50;
...
/*
===============================================
= VARIABLES FOR THE EXECUTION OF EVENT SYSTEM =
===============================================
*/
std::string sysreqs[100];
int system_event_id[100];
int last_exec = 0;
int rq_ptr = 0;
